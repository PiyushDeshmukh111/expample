 <div class="sidebar-wrapper" data-simplebar="true">
            <div class="sidebar-header">
                <div class="">
                    <img src="{{asset('public/assets/images/Salasar Group Orange Logo-8.png')}}" class="logo-icon-2"style="width: 70px" alt="" />
                </div>
                <div>
                    <h6 class="logo-text" style="font-size: 16px;margin-left: 28px;">Assets Tracking</h6>
                </div>
       ...
       <!--          <li> -->
           <!--          <a class="has-arrow" href="javascript:;">
                ...
                <li>
                    ...
                    <ul>
                        <li> <a href="{{url('/assetList')}}"><i class="bx bx-right-arrow-alt"></i>Assets Type</a>
                        </li>
                        <li> <a href="{{url('/assetbrand')}}"><i class="bx bx-right-arrow-alt"></i>Assets Brand</a>
                        </li>
