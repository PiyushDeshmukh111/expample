...
@if (Session::has('update'))
              ...
              @endif
           <div>
          <a href="{{ url('/creategallaryList') }}" style="margin-left: 16px" class="btn btn-primary btn-sm float-end" title="Add New " enctype="multipart/form-data">
            <i class="fa fa-plus" aria-hidden="true"></i> Add Gallary </a> 
            <a href="{{ url('/gallaryshow') }}" class="btn btn-secondary btn-sm float-end" title="show gallary" enctype="multipart/form-data"> 
